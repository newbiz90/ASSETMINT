...
# Seed data for subscriptions
subscription2 = Subscription.new(subscribable: user_ticker2, user: user2)
puts "Subscription 2 valid?: #{subscription2.valid?}"
puts "Subscription 2 errors: #{subscription2.errors.full_messages}"
subscription2.save

# Seed data for subscriptions
subscription3 = Subscription.new(subscribable: user_ticker4, user: user1)
...
# Seed data for subscriptions
subscription4 = Subscription.new(subscribable: user_ticker3, user: user1)
puts "Subscription 4 valid?: #{subscription4.valid?}"
puts "Subscription 4 errors: #{subscription4.errors.full_messages}"
subscription4.save

# subscription2 = Subscription.new(subscribable: user2, user_ticker: user_ticker2)
# puts "Subscription 2 valid?: #{subscription2.valid?}"
# puts "Subscription 2 errors: #{subscription2.errors.full_messages}"
# subscription2.save
...
transaction1 = Transaction.new(user_ticker: user_ticker1, user: user_ticker1.user, flow: 'Buy', txndate: Date.today, txnprice: 100.00, qty: 10, comment: 'Bought 10 shares of AAPL')
...
transaction2 = Transaction.new(user_ticker: user_ticker2, user: user_ticker2.user, flow: 'Sell', txndate: Date.today, txnprice: 110.00, qty: 5, comment: 'Sold 5 shares of GOOGL')
puts "Transaction 2 valid?: #{transaction2.valid?}"
puts "Transaction 2 errors: #{transaction2.errors.full_messages}"
transaction2.save

# Create a transaction for the first user_ticker
transaction3 = Transaction.new(user_ticker: user_ticker1, user: user_ticker1.user, flow: 'Buy', txndate: Date.today, txnprice: 100.00, qty: 10, comment: 'Bought 10 shares of AAPL')
puts "Transaction 3 valid?: #{transaction3.valid?}"
puts "Transaction 3 errors: #{transaction3.errors.full_messages}"
transaction3.save

# Create a transaction for the first user_ticker
transaction4 = Transaction.new(user_ticker: user_ticker1, user: user_ticker1.user, flow: 'Sell', txndate: Date.today, txnprice: 90.00, qty: 90, comment: 'Sold 90 shares of AAPL')
puts "Transaction 4 valid?: #{transaction4.valid?}"
puts "Transaction 4 errors: #{transaction4.errors.full_messages}"
transaction4.save

# Create a transaction for the second user_ticker
transaction5 = Transaction.new(user_ticker: user_ticker3, user: user_ticker3.user, flow: 'Sell', txndate: Date.today, txnprice: 110.00, qty: 5, comment: 'Sold 5 shares of X')
puts "Transaction 5 valid?: #{transaction2.valid?}"
puts "Transaction 5 errors: #{transaction2.errors.full_messages}"
transaction5.save

# Create a transaction for the second user_ticker
transaction6 = Transaction.new(user_ticker: user_ticker4, user: user_ticker4.user, flow: 'Sell', txndate: Date.today, txnprice: 20.00, qty: 7, comment: 'Sold 7 shares of GOOGL')
puts "Transaction 6 valid?: #{transaction2.valid?}"
puts "Transaction 6 errors: #{transaction2.errors.full_messages}"
transaction6.save

# Create a transaction for the second user_ticker
transaction7 = Transaction.new(user_ticker: user_ticker4, user: user_ticker4.user, flow: 'Buy', txndate: Date.today, txnprice: 63.00, qty: 11, comment: 'Bought 11 shares of A')
puts "Transaction 7 valid?: #{transaction2.valid?}"
puts "Transaction 7 errors: #{transaction2.errors.full_messages}"
transaction7.save

# Create a transaction for the second user_ticker
transaction8 = Transaction.new(user_ticker: user_ticker2, user: user_ticker2.user, flow: 'Buy', txndate: Date.today, txnprice: 73.00, qty: 5, comment: 'Bought 5 shares of GOOGL')
puts "Transaction 8 valid?: #{transaction8.valid?}"
puts "Transaction 8 errors: #{transaction8.errors.full_messages}"
transaction8.save

# Create a transaction for the second user_ticker
transaction9 = Transaction.new(user_ticker: user_ticker3, user: user_ticker3.user, flow: 'Sell', txndate: Date.today, txnprice: 110.00, qty: 5, comment: 'Sold 5 shares of GOOGL')
puts "Transaction 9 valid?: #{transaction9.valid?}"
puts "Transaction 9 errors: #{transaction9.errors.full_messages}"
transaction9.save

# Create a transaction for the second user_ticker
transaction10 = Transaction.new(user_ticker: user_ticker4, user: user_ticker4.user, flow: 'Buy', txndate: Date.today, txnprice: 17.00, qty: 23, comment: 'Bought 23 shares of P')
